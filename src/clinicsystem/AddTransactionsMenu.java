 ...
 * @author c7-ong
 */
public class AddTransactionsMenu extends javax.swing.JFrame {

    /**
     * Creates new form AddTransactionsMenu
     */
    String role;
    public AddTransactionsMenu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Add new transaction");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddTransactionsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTransactionsMenu().setVisible(true);
            }
        });
    }
